...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '5356d735b60953a9e4d1ee0912eba302::card','data' => ['class' => 'flex flex-col w-full max-w-4xl mx-auto lg:my-10']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '5356d735b60953a9e4d1ee0912eba302::settings-sidebar-link','data' => ['href' => route('settings.profile'),'icon' => 'phosphor-user-circle-duotone']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginal7d540a9187ebd554b18841c6f28f4b36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7d540a9187ebd554b18841c6f28f4b36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '5356d735b60953a9e4d1ee0912eba302::settings-sidebar-link','data' => ['href' => route('settings.security'),'icon' => 'phosphor-lock-duotone']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('settings-sidebar-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginal7d540a9187ebd554b18841c6f28f4b36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7d540a9187ebd554b18841c6f28f4b36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '5356d735b60953a9e4d1ee0912eba302::settings-sidebar-link','data' => ['href' => route('settings.api'),'icon' => 'phosphor-code-duotone']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('settings-sidebar-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                ...
                <div class="flex items-center w-full ml-2 space-x-2 lg:items-stretch lg:flex-col lg:ml-0 lg:space-y-1 lg:space-x-0">
                    <?php if (isset($component)) { $__componentOriginal7d540a9187ebd554b18841c6f28f4b36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7d540a9187ebd554b18841c6f28f4b36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '5356d735b60953a9e4d1ee0912eba302::settings-sidebar-link','data' => ['href' => route('settings.subscription'),'icon' => 'phosphor-credit-card-duotone']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('settings-sidebar-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginal7d540a9187ebd554b18841c6f28f4b36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7d540a9187ebd554b18841c6f28f4b36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '5356d735b60953a9e4d1ee0912eba302::settings-sidebar-link','data' => ['href' => route('settings.invoices'),'icon' => 'phosphor-invoice-duotone']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('settings-sidebar-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\costify3d\resources\themes\Costify3D\components\app\settings-layout.blade.php ENDPATH**/ ?>