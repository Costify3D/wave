<div>
    <div class="flex flex-col justify-center items-center w-full h-screen bg-zinc-50">
        ...
        <a href="<?php echo e(url('admin')); ?>" class="flex absolute top-0 left-0 items-center pt-5 pl-5 mb-5 ml-5 font-medium text-zinc-900 group lg:w-auto lg:items-center lg:justify-center md:mb-0">
        ...
        <?php if(!$app_id): ?>
            <div class="overflow-hidden mx-auto w-full max-w-lg bg-white rounded-lg border shadow-xl border-zinc-100">
                <div class="flex relative items-center pl-5 w-full h-20 text-white bg-center bg-cover bg-gradient-to-br from-blue-500 to-blue-600" style="background-image:url('<?php echo e(Storage::url('/settings/April2021/deploy-banner.png')); ?>')">
                    <img src="<?php echo e(Storage::url('/settings/April2021/deploy-to-do.png')); ?>" class="w-10 h-10">
            ...
            <div class="mx-auto w-full max-w-lg">
                ...
                <div class="overflow-hidden bg-white rounded-lg border shadow-xl border-zinc-100">
                    ...
                    <div class="flex relative flex-col p-8 h-full">
                        <h2 class="font-bold text-black"><?php echo e($app['app']['spec']['name']); ?></h2>
                        <a href="<?php echo e($app['app']['live_url_base'] ?? '#'); ?>" target="_blank" class="text-sm font-medium text-blue-500 underline"><?php echo e($app['app']['live_url_base'] ?? 'Deploying...'); ?></a>
                        <a href="https://cloud.digitalocean.com/apps/<?php echo e($app_id); ?>" target="_blank" class="inline-block px-5 py-3 mt-5 w-full text-sm font-bold text-center text-white bg-blue-600 rounded-lg">Configure on DigitalOcean</a>
                    </div>
                </div>

                <h3 class="my-5 text-sm font-bold text-zinc-500">Deployments</h3>
                <?php $__currentLoopData = $deployments['deployments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deployment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $success = false;
                    ...
                    <div class="flex overflow-hidden items-center p-5 bg-white rounded-lg border shadow-xl border-zinc-100">
                        <div class="flex relative justify-center items-center mr-3 h-full">
                            <div class="w-4 h-4 <?php if($success): ?><?php echo e('bg-green-400'); ?><?php else: ?><?php echo e('bg-red-400'); ?><?php endif; ?> rounded-full"></div>
                        </div>
                        <div class="flex relative justify-between items-center w-full text-sm">
                            <p class="flex items-center h-full font-medium leading-none text-zinc-700"><?php echo e($deployment['cause']); ?> on <?php echo e(Carbon\Carbon::parse($deployment['created_at'])->format('F jS, h:i A')); ?></p>
                            <a href="https://cloud.digitalocean.com/apps/<?php echo e($app_id); ?>/deployments/<?php echo e($deployment['id']); ?>" target="_blank" class="text-blue-500 hover:text-blue-600">
...
</div><?php /**PATH C:\laragon\www\costify3d\resources\views\livewire\wave\deploy-to-do.blade.php ENDPATH**/ ?>