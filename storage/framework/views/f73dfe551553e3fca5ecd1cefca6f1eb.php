...
<?php echo app('translator')->get('mail_contact.read_on_website'); ?>
...
<p style="text-align: center; color: #718096; font-size: 12px; line-height: 1.5;">
    <?php echo app('translator')->get('mail_contact.unsubscribe'); ?> <a href="<?php echo new \Illuminate\Support\EncodedHtmlString($user->unsubscribeUrl()); ?>" style="color: #3b82f6;"><?php echo app('translator')->get('mail_contact.unsubscribe here'); ?></a>.
</p>
