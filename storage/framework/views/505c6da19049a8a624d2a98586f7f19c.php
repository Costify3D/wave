...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-widgets::components.widget','data' => ['columnSpan' => 'xl','class' => 'fi-filament-info-widget']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['columnSpan' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('xl'),'class' => 'fi-filament-info-widget']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','href' => 'https://wave.devdojo.com/docs','icon' => 'heroicon-m-book-open','icon-alias' => 'panels::widgets.filament-info.open-documentation-button','rel' => 'noopener noreferrer','target' => '_blank']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','href' => 'https://github.com/thedevdojo/wave','icon-alias' => 'panels::widgets.filament-info.open-github-button','rel' => 'noopener noreferrer','target' => '_blank']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\costify3d\wave\resources\views\widgets\wave-stats-widget.blade.php ENDPATH**/ ?>