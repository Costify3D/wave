...
<script>
	...
	<?php if(config('settings.stripe_mode') == 'live'): ?>
		var stripe = Stripe('<?php echo e(config('settings.stripe_live_key')); ?>');
	<?php else: ?>
		var stripe = Stripe('<?php echo e(config('settings.stripe_test_key')); ?>');
	<?php endif; ?>
...
</script><?php /**PATH C:\laragon\www\costify3d\resources\themes\Costify3D\partials\payment-form.blade.php ENDPATH**/ ?>