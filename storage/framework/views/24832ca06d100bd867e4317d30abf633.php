...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '96f8a32918383f00e0c445c8d4ba4d74::marketing.elements.heading','data' => ['level' => 'h2','title' => ''.e(__('landingpage.pricing_title')).'','description' => ''.e(__('landingpage.pricing_description')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['level' => 'h2','title' => ''.e(__('landingpage.pricing_title')).'','description' => ''.e(__('landingpage.pricing_description')).'']); ?>
                    ...
                    <div class="flex flex-col lg:mb-10 h-full bg-white rounded-xl border-2  <?php if($plan->default): ?><?php echo e('border-zinc-900 lg:scale-105'); ?><?php else: ?><?php echo e('border-zinc-200'); ?><?php endif; ?> shadow-sm sm:mb-0">
                        <div class="px-8 pt-8">
                            <span class="px-4 py-1 text-base font-medium text-white rounded-full bg-zinc-900 text-uppercase" data-primary="indigo-700">
                                ...
                                <?php echo e(__('plans.' . strtolower($plan->name) . '_name')); ?>
                        ...
                        <div class="px-8 mt-5">
                            ...
                            <span x-text="billing == 'Monthly' ? '/<?php echo e(__('plans.abbr_month')); ?>' : '/<?php echo e(__('plans.abbr_year')); ?>'"></span></span>
                        </div>

                        <div class="px-8 pb-10 mt-3">
                            
                            <p class="text-base leading-7 text-zinc-500"><?php echo e(__('plans.' . strtolower($plan->name) . '_description')); ?></p>
                        </div>
                        ...
                        <div class="p-8 mt-auto rounded-b-lg bg-zinc-50">
                            <ul class="flex flex-col">
                                ...
                                <?php 
                                    $featureKeys = is_string($plan->features) ? explode(',', $plan->features) : []; 
                                ?>
                                <?php $__currentLoopData = $featureKeys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featureKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="mt-1">
                                        <span class="flex items-center text-green-500">
                                            ...
                                            <span class="text-zinc-700">
                                                ...
                                                <?php echo e(__('plan_features.' . $featureKey)); ?>
...
<?php $component->withAttributes(['class' => 'w-full','tag' => 'a','href' => '/settings/subscription']); ?>
                                    <?php echo e(__('buttons.get_started')); ?>
...
<?php endif; ?>
    ...
    <p class="w-full mt-0 mb-8 text-center text-zinc-500 sm:my-10"><?php echo e(__('landingpage.pricing_footer')); ?></p>
