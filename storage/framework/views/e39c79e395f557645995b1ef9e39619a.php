            ...
            <div class="px-8 pt-6 pb-8 space-y-6">
                ...
                <div>
                    <nav class="grid row-gap-8">
                        <a href="<?php echo e(route('wave.dashboard')); ?>" class="flex items-center p-3 -m-3 space-x-3 rounded-md transition duration-150 ease-in-out hover:bg-zinc-50">
                        ...
                        <a href="<?php echo e(route('blog')); ?>" class="flex items-center p-3 -m-3 space-x-3 rounded-md transition duration-150 ease-in-out hover:bg-zinc-50">
...
<?php /**PATH C:\laragon\www\costify3d\resources\themes\Costify3D\partials\menus\app-mobile.blade.php ENDPATH**/ ?>