<label class="inline-flex items-start space-x-2 cursor-pointer select-none">
    <div class="relative translate-y-0">
        <input type="checkbox" <?php echo e($attributes); ?> class="sr-only peer">
    ...
    <span class="relative">
        <span class="block text-sm font-medium leading-tight text-gray-900"><?php echo e($title ?? ''); ?></span>
        <?php if(($description ?? false)): ?>
            <span class="text-sm leading-tight text-gray-400"><?php echo e($description); ?></span>
        <?php endif; ?>
    </span>
</label>
<?php /**PATH C:\laragon\www\costify3d\vendor\devdojo\auth\resources\views\components\setup\checkbox-title-description.blade.php ENDPATH**/ ?>