...
<body 
        ...
        <div class="flex justify-center items-start w-full h-full">
            ...
            <main class="flex justify-center items-center w-full h-full">
                <div x-data="{ fullscreen: false }" class="flex relative w-full">
                    <?php echo $__env->make('auth::includes.setup.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <?php echo $__env->make('auth::includes.setup.preview', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>        

</body>
</html><?php /**PATH C:\laragon\www\costify3d\vendor\devdojo\auth\resources\views\components\layouts\setup.blade.php ENDPATH**/ ?>