...
<?php endif; ?>
    ...
    <div class="relative space-y-2 w-full <?php if(config('devdojo.auth.settings.social_providers_location') != 'top' && !$separator): ?><?php echo e('mt-3'); ?><?php endif; ?>">
        <?php $__currentLoopData = $socialProviders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug => $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\costify3d\vendor\devdojo\auth\resources\views\components\elements\social-providers.blade.php ENDPATH**/ ?>