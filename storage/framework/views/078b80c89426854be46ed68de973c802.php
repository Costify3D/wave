...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '96f8a32918383f00e0c445c8d4ba4d74::app.container','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '5356d735b60953a9e4d1ee0912eba302::card','data' => ['class' => 'lg:p-10']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '96f8a32918383f00e0c445c8d4ba4d74::app.heading','data' => ['title' => 'Changelog','description' => 'This is your application changelog where users can visit to stay in the loop about your latest updates and improvements.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Changelog','description' => 'This is your application changelog where users can visit to stay in the loop about your latest updates and improvements.']); ?>
...
<?php endif; ?>
        ...
        <div class="max-w-full mt-8 prose-sm prose dark:prose-invert">
                <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $changelog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex flex-col items-start space-y-3 lg:flex-row lg:space-y-0 lg:space-x-5">
                        <div class="flex-shrink-0 px-2 py-1 text-xs translate-y-1 rounded-full bg-zinc-100 dark:bg-zinc-600">
                            <time datetime="<?php echo e(Carbon\Carbon::parse($changelog->created_at)->toIso8601String()); ?>" class="ml-1"><?php echo e(Carbon\Carbon::parse($changelog->created_at)->toFormattedDateString()); ?></time>
                        </div>
                        <div class="relative">
                            <a href="<?php echo e(route('changelog', ['changelog' => $changelog->id])); ?>" class="text-xl no-underline hover:underline" wire:navigate><?php echo e($changelog->title); ?></a>
...
<?php endif; ?><?php /**PATH C:\laragon\www\costify3d\resources\themes\Costify3D\pages\changelog\index.blade.php ENDPATH**/ ?>