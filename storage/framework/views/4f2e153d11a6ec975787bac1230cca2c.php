...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '1929d69541870f736d4a47ee2f87330b::layouts.app','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '1929d69541870f736d4a47ee2f87330b::app.container','data' => ['xData' => true,'class' => 'lg:space-y-6','xCloak' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '1929d69541870f736d4a47ee2f87330b::app.alert','data' => ['id' => 'dashboard_alert','class' => 'hidden lg:flex']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '1929d69541870f736d4a47ee2f87330b::app.dashboard-card','data' => ['href' => 'https://devdojo.com/wave/docs','target' => '_blank','title' => 'Documentation','description' => 'Learn how to customize your app and make it shine!','linkText' => 'View The Docs','image' => '/wave/img/docs.png']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
		...
		<div class="flex flex-col w-full mt-5 space-y-5 md:flex-row md:space-y-0 md:mb-0 md:space-x-5">
			<?php if (isset($component)) { $__componentOriginal4b076528ded6bc2b3b1e40d6a6b28ad3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4b076528ded6bc2b3b1e40d6a6b28ad3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '1929d69541870f736d4a47ee2f87330b::app.dashboard-card','data' => ['href' => 'https://github.com/thedevdojo/wave','target' => '_blank','title' => 'Github Repo','description' => 'View the source code and submit a Pull Request','linkText' => 'View on Github','image' => '/wave/img/laptop.png']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('app.dashboard-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
			<?php if (isset($component)) { $__componentOriginal4b076528ded6bc2b3b1e40d6a6b28ad3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4b076528ded6bc2b3b1e40d6a6b28ad3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '1929d69541870f736d4a47ee2f87330b::app.dashboard-card','data' => ['href' => 'https://devdojo.com','target' => '_blank','title' => 'Resources','description' => 'View resources that will help you build your SaaS','linkText' => 'View Resources','image' => '/wave/img/globe.png']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('app.dashboard-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '1929d69541870f736d4a47ee2f87330b::app.message-for-subscriber','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '1929d69541870f736d4a47ee2f87330b::app.message-for-admin','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\costify3d\resources\themes\Costify3D\pages\dashboard\index.blade.php ENDPATH**/ ?>