...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '1929d69541870f736d4a47ee2f87330b::elements.back-button','data' => ['class' => 'max-w-3xl mx-auto mt-4 md:mt-8','text' => 'Return Back Home','href' => route('home')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
