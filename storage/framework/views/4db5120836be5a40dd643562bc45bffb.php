...
<?php endif; ?>
    ...
    <?php if(($description ?? false) && $show_subheadline): ?>
        <p id="auth-heading-description" class="mb-1.5 space-x-0.5 text-sm leading-5 text-center opacity-[67%]"><?php echo e($description ?? ''); ?></p>
    <?php endif; ?>
</div><?php /**PATH C:\laragon\www\costify3d\vendor\devdojo\auth\resources\views\components\elements\heading.blade.php ENDPATH**/ ?>