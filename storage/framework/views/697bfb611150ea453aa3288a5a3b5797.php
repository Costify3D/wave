...
<?php $component->withAttributes(['wire:model' => 'destinationFolder','label' => 'Select Destination Folder','placeholder' => 'Select a folder']); ?>
                ...
                <?php if(!$this->isRootDirectory()): ?>
                    <option value=".." selected>Previous Folder (../)</option>
                <?php endif; ?>
                <?php $__currentLoopData = $this->getFoldersInCurrentDirectory(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($selectedFile != null && $selectedFile['name'] != $folder): ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\costify3d\wave\resources\views\media\views\header\move.blade.php ENDPATH**/ ?>