			...
			<div class="flex flex-col justify-between w-full mt-2">
				...
				<div class="mt-5 sm:mt-6 sm:flex sm:flex-row-reverse">
					<div class="flex flex-1 w-full rounded-md shadow-sm sm:ml-3 sm:w-full">
                        <form id="form" action="<?php echo e(route('wave.switch-plans')); ?>" method="POST" class="w-full">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\costify3d\resources\themes\Costify3D\partials\switch-plans-modal.blade.php ENDPATH**/ ?>